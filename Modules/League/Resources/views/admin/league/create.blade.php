...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">ساخت لیگ</li>
        </ol>
    </nav>
    <!-- breadcrumb -->
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="pb-0 mb-2">
                <div class="d-flex justify-content-between">
                    <div class="d-flex gap-2">
                        <h4 class="card-title mg-b-0">لیگ</h4>
                        <p class="tx-12 tx-gray-500 mb-2">ساخت لیگ.
            ...
            {{-- form --}}
            <form action="{{ route('admin.league.store') }}" id="form" method="post" enctype="multipart/form-data">
                @csrf
