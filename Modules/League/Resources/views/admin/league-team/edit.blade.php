...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">ویرایش تیم</li>
        </ol>
    </nav>
    <!-- breadcrumb -->
    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="pb-0 mb-2">
                <div class="d-flex justify-content-between">
                    <div class="d-flex gap-2">
                        ...
                        <p class="tx-12 tx-gray-500 mb-2">ویرایش تیم.
            ...
            {{-- form --}}
            <form action="{{ route('admin.league-team.update', $team) }}" id="form" method="post" enctype="multipart/form-data">
                @csrf @method('PUT')
                ...
                <div class="row">
                                ...
                                <div>
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="form-label @error('name') tx-danger @enderror">نام تیم:
                                            <span class="tx-danger">*</span></label>
                                        <input type="text" name="name" class="form-control @error('name') border-danger @enderror" value="{{ old('name', $team->name) }}">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="slug" class="form-control" value="{{ old('slug', $team->slug) }}">
                    ...
                    <div class="col-4">
                        {{-- image --}}
                        <div class="form-group mb-4">
                            <input type="file" name="logo" class="dropify" data-default-file="{{ asset($team->logo) }}" data-height="200">
