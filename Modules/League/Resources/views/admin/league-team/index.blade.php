...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">تیم ها</li>
        </ol>
    </nav>
    <!-- breadcrumb -->
            ...
            <div class="pb-0 mb-2">
                <div class="d-flex justify-content-between">
                    <div class="d-flex gap-2">
                        <h4 class="card-title mg-b-0"> تیم ها</h4>
                        <p class="tx-12 tx-gray-500 mb-2">نمایش {{ $teams->currentPage() }} از {{ $teams->lastPage() }} صفحه از همه {{ $teamsCount }} مورد .
                            <a href="{{ route('admin.league-team') }}" id="m-l-c-05">تازه سازی </a>
                        </p>
                    </div>
                </div>
                <a href="{{ route('admin.league-team.create') }}" class="btn p-2 btn-primary"><i class="fe fe-plus"></i> ساخت تیم
                </a>
            </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <table class="table text-md-nowrap dataTable no-footer" id="example1" role="grid" aria-describedby="example1_info">
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="wd-15p border-bottom-0 sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="اسلاگ: activate to sort column ascending" style="width: 101.667px;">لیگ</th>
                                        ...
                                        @foreach($teams as $team)
                                            <tr>
                                                ...
                                                <td class="d-flex justify-content-start">
                                                    <a href="{{ route('admin.league-team.edit', $team) }}" class="btn-sm"><i class="fe fe-edit"></i> ویرایش</a>
                                                    <form action="{{ route('admin.league-team.destroy', $team) }}" method="post">
                                                        @csrf @method('delete')
                                    ...
                                    <div class="col-12 mt-4 text-left">
                                        {{ $teams->links('vendor.pagination.bootstrap-5', ['elements' => $teams]) }}
                                    </div>
