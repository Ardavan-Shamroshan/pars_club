    ...
    <div class="panel-box rounded">
        <div class="titles no-margin bg-light">
            <h4><i class="fe fe-paperclip"></i>مطالب داغ</h4>
        </div>
                ...
                <div class="tab-menu-heading">
                    <div class="tabs-menu ">
                        ...
                        <ul class="nav panel-tabs small">
                            <li class="">
                                <a href="#tab1" data-bs-toggle="tab" class="active px-2 py-1 "> دیدگاه</a>
                            </li>
                            <li class="">
                                <a href="#tab2" data-bs-toggle="tab" class="px-2 py-1"> بازدید</a>
                            </li>
                            <li class="">
                                <a href="#tab3" data-bs-toggle="tab" class="px-2 py-1"> لایک</a>
                            </li>

                        </ul>
                    </div>
                </div>
                <div class="panel-body tabs-menu-body m-0 p-0">
